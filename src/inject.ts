...
export function injectContent(pkg: Package, refresh = false) {
    ...
    <details id="npm-stats-details" class="details-reset details-overlay BtnGroup-parent js-user-list-menu d-inline-block position-relative"${
			refresh ? ' open' : ''
		}>
    ...
    <path d="m4.427 7.427 3.396 3.396a.25.25 0 0 0 .354 0l3.396-3.396A.25.25 0 0 0 11.396 7H4.604a.25.25 0 0 0-.177.427Z"></path>
      ...
      <details-menu class="select-menu-modal position-absolute" style="animation-name: SelectMenu-modal-animation--sm;">
            ...
            <footer class="SelectMenu-footer px-2">
                <button id="npm-stats-refresh" type="button" data-view-component="true" class="user-lists-menu-action js-user-lists-create-trigger btn-invisible btn btn-block text-normal rounded-1 px-2"${
									new Date().getTime() - pkg.lastChecked < 86400000
										? ' disabled'
										: ''
								}>
